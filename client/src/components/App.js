        ...
        <div className="Main">
          <div className="App">
            <header className="App-header">
              ...
              <p className="App-intro">Deadline for voting is set at 11:00 AM of every friday<span role="img" aria-label="icon">🕚</span></p>
              <p className="App-intro">You MUST vote max. 3 pizzas</p>
            </header>
